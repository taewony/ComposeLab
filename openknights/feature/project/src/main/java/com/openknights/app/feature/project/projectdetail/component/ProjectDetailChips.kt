...
import com.openknights.app.feature.project.projectdetail.model.ProjectDetailContentProvider
...
@Composable
private fun PreviewProjectDetailChips(@PreviewParameter(ProjectDetailContentProvider::class) project: Project) {
    KnightsTheme {
        ProjectDetailChips(
            project = project,
        )
